<h2><a href="https://www.geeksforgeeks.org/problems/sum-of-n-number/1?page=2&category=Java&status=unsolved&sortBy=submissions">Sum of N Numbers</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an integer<strong> n&nbsp;</strong>find the sum of the first <strong>n</strong>&nbsp;natural number<strong>.</strong></span></p>
